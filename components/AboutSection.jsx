    ...
    <section className='text-white' id='about'>
        <div className='md:grid md:grid-cols-2 gap-8 items-cecnter py-8 xl:gap-16 sm:py-16'>
            ...
            <div>
                ...
                <p className='text-[#ADB7BE] text-base lg:text-lg'>I&apos;m a 21-year-old currently in my third year pursuing a Bachelor of Science in Information Technology at the University of San Jose-Recoletos. Passionate about technology and eager to learn, I&apos;m exploring the dynamic world of IT, embracing every opportunity to expand my knowledge and skills in the field.</p>
                <div className='flex flex-row mt-8'>
                  <TabBtn selectTab={() => handleTabChange('skills')} active={tab === 'skills'}>
                    {" "}Skills{" "}
                  </TabBtn>
                  <TabBtn selectTab={() => handleTabChange('education')} active={tab === 'education'}>
                    {" "}Education{" "}
                  </TabBtn>
                </div>
                <div className="mt-8">
