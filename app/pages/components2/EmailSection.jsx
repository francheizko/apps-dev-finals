    ...
    >
      <div>
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/evrylsem" legacyBehavior>
            <Image src={GithubIcon} alt="github" width={60} />
          </Link>
          <Link href="https://facebook.com/evrylclaire" legacyBehavior>
            <Image src={FacebookIcon} alt="facebook" width={60} />
          </Link>
          <Link href="https://www.instagram.com/evrylclaire/" legacyBehavior>
      ...
      <div>
        ...
        <div className="flex items-center space-x-2">
          <Image
            ...
            className="object-contain"
          />
          <p className="text-[#ADB7BE] max-w-md">+639-99924-1439</p>
        </div>
        <div className="flex items-center space-x-2">
          <Image
            src="/images/home.png"
